...
async def call_beauty_ai(
    ...
    # SYSTEM + STRATEGY + PROFILE + HISTORY + TYPE + STORY + NATURAL_FLOW + CTA + HUMAN + READABILITY + FORMATTING + ANTI_AI + HUMAN_EDITOR
    system_instruction_text = (
        SYSTEM_PROMPT + STRATEGY_PROMPT + profile_prompt + history_prompt + type_prompt + STORY_PROMPT + NATURAL_FLOW_PROMPT + CTA_PROMPT + HUMAN_PROMPT + READABILITY_PROMPT + FORMATTING_PROMPT + ANTI_AI_PROMPT + HUMAN_EDITOR_PROMPT
    )
